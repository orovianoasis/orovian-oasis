...
// Optional visual enhancements loader.
// If enhancements.js is deleted or missing, the site still works normally.
(function loadOptionalEnhancements() {
  const optionalScript = document.createElement("script");
  optionalScript.src = "enhancements.js";
  optionalScript.defer = true;
  optionalScript.dataset.optional = "true";
  optionalScript.onerror = () => optionalScript.remove();
